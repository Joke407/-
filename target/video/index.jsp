	...
	<script type="text/javascript">
		...
		function getCount(methodName, videoTitle, videoSpeaker, videoSource) {
			...
			$.ajax({
						...
						url : 'http://47.93.50.87:8080/video/video/count',
		...
		function loadVideo(pageNum) {
			...
			$.ajax({
						...
						url : 'http://47.93.50.87:8080/video/video/list',
		...
		function loadSpeaker() {
			$.ajax({
						...
						url : 'http://47.93.50.87:8080/video/speaker/list',
		...
		function loadCourse() {
			$.ajax({
						...
						url : 'http://47.93.50.87:8080/video/course/list',
		...
		function loadSubject() {
			$.ajax({
				...
				url : 'http://47.93.50.87:8080/video/subject/list',
		...
		function saveVideo() {
			$.ajax({
						...
						url : 'http://47.93.50.87:8080/video/video/save',
		...
		function deleteVideos() {
			...
			$.ajax({
				...
				url : 'http://47.93.50.87:8080/video/video/remove',
		...
		function updateVideo() {
			$.ajax({
				...
				url : 'http://47.93.50.87:8080/video/video/update',
		...
		function saveSpeaker() {
			$.ajax({
						...
						url : 'http://47.93.50.87:8080/video/speaker/save',
		...
		function deleteSpeaker(id) {
			...
			$.ajax({
				...
				url : 'http://47.93.50.87:8080/video/speaker/remove',
		...
		function updateSpeaker() {
			$.ajax({
				...
				url : 'http://47.93.50.87:8080/video/speaker/update',
		...
		function saveCourse() {
			$.ajax({
						...
						url : 'http://47.93.50.87:8080/video/course/save',
		...
		function deleteCourse(id) {
			$.ajax({
				...
				url : 'http://47.93.50.87:8080/video/course/remove',
		...
		function updateCourse() {
			$.ajax({
				...
				url : 'http://47.93.50.87:8080/video/course/update',
